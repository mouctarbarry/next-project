...
const FormSchema = z.object({
    id: z.string(),
    customerId: z.string({
        invalid_type_error: 'Please enter a valid customer',
    }),
...
// Schéma pour la création de facture (sans id et date)
 ...
 * @param formData - Les données du formulaire de mise à jour.
 */
